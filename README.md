...
My current main stack is Node.js, but the best tool is the one that best fits the use case.

I've build apps using Java, Python, C/C++, Scala, Go, Rust, and Node.js.
